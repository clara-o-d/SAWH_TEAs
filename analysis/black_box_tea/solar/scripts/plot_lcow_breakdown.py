#!/usr/bin/env python3
"""Plot stacked LCOW cost breakdown from solar_sawh_tea.xlsx."""
...
_DEFAULT_WORKBOOK = _REPO / "solar_sawh_tea.xlsx"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot LCOW cost breakdown from solar black-box TEA")
