...
for _p in (_SCRIPTS, _SRC, _ANALYSIS_DIR):
    if str(_p) not in sys.path:
        sys.path.insert(0, str(_p))

from lcow_random_global_map_waste_heat_lumped import (  # noqa: E402
    FAIL_LCO,
    SaltAttemptResult,
    SiteResult,
    parse_salt_names,
...
from waste_heat_lumped.physics import CANDIDATE_SALTS
