#!/usr/bin/env python3
"""Run ``run_waste_heat_sim`` for one site and plot LCOW cost breakdown (black_box_tea style).
...
_SRC = _REPO / "src"
_TEA_ROOT = _REPO.parent.parent / "analysis" / "black_box_tea"
...
from waste_heat_lumped.economics import KG_WATER_PER_M3  # noqa: E402
