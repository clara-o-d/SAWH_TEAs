...
MATLAB scripts live in:  analysis/paper_recreation/matlab/recreation/

Usage (from analysis/paper_recreation/):
  python export_recreation_matlab_data_waste_heat_lumped.py
  python export_recreation_matlab_data_waste_heat_lumped.py --figures diaz5 wilson3
...
_PAPER_RECREATION = _SCRIPT.parent
_SOLAR_ROOT = _PAPER_RECREATION.parent.parent / "waste-heat" / "lumped"
