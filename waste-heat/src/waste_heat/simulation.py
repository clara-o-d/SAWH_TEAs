...
def compute_controls(
    *,
    ...
    """Vacuum conductance tracks adsorption-limited desorption. Half-cycles end when
    vapor-gap RH outside the desorber drops below the switch threshold, with
    ṁ_ads = ṁ_des enforced in ``sorbent.mass_rates``."""
...
def find_cyclic_state(
    ...
    *,
    ...
    averaging the two most recent extrapolated states (also the ``max_rounds`` fallback)."""
