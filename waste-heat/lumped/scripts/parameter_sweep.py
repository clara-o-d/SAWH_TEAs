...
from waste_heat_lumped.economics import LcowCostBreakdown  # noqa: E402
from waste_heat_lumped.economics import npv_from_daily_yield  # noqa: E402
from waste_heat_lumped.economics import LCOEconomicParams  # noqa: E402
from waste_heat_lumped.physics import VAPOR_GAP_M  # noqa: E402
from waste_heat_lumped.physics import get_salt  # noqa: E402
...
def make_sweep_params(
    ...
    return [
        ...
        SweepParam("vapor_gap_mm", "Vapor gap (mm)", 7.0, 60.0, VAPOR_GAP_M * 1e3),
        # External
