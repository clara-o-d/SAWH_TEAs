...
from waste_heat_lumped.physics import hx_effectiveness_q
from waste_heat_lumped.physics import q_f_to_gel_w_m2
from waste_heat_lumped.physics import dc_w_dt, concentration_ratio_absorption
from waste_heat_lumped.physics import equilibrium_c_w_at_rh
from waste_heat_lumped.simulation import detailed_series, write_detailed_csv
from waste_heat_lumped.simulation import DeviceConfig
from waste_heat_lumped.simulation import run_daily_cycle
from waste_heat_lumped.weather import datacenter_baseline_profile
...
def test_q_f_to_gel_positive_during_desorption():
    q = q_f_to_gel_w_m2(
        ...
        ua_gel_w_k=UA_GEL_W_K,
        fluid_cp_j_kg_k=FLUID_CP_J_KG_K,
    )
    assert q > 0.0
...
def test_gel_balance_structure():
    ...
    from waste_heat_lumped.physics import solve_steady_gel_thermal
