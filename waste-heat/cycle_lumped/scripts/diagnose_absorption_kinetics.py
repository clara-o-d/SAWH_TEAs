...
from waste_heat_cycle_lumped.physics import mass_transfer_params
from waste_heat_cycle_lumped.physics import RH_AMB, T_AMB_C
from waste_heat_cycle_lumped.simulation import DeviceConfig
from waste_heat_cycle_lumped.simulation import run_cycle
...
def _print_state_comparison(config: DeviceConfig) -> None:
    ...
    from waste_heat_cycle_lumped.physics import WATER_MOLAR_MASS_KG_MOL
