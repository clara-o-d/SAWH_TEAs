...
from waste_heat_cycle_lumped.physics import H_FG_J_PER_KG
from waste_heat_cycle_lumped.simulation import simulate_daily
from waste_heat_cycle_lumped.simulation import DeviceConfig
from waste_heat_cycle_lumped.simulation import CycleResult, HalfCycleResult
...
def test_minimum_specific_energy_is_latent_heat():
    assert minimum_specific_energy_kwh_per_l() == pytest.approx(H_FG_J_PER_KG / 3.6e6)
