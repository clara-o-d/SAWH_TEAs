#!/usr/bin/env python3
"""Run ``run_waste_heat_sim`` for one site and plot LCOW cost breakdown (solar_black_box style).
...
from waste_heat_lumped.economics.params import KG_WATER_PER_M3  # noqa: E402
