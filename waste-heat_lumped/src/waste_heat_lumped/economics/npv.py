...
Same cost model as ``lcow.py`` (BOM CAPEX, hydrogel/sorbent replacement,
energy, parasitic electricity), but CAPEX is paid up front at year 0 instead
...
from waste_heat_lumped.economics.lcow import _sorbent_replacement_annual_usd
from waste_heat_lumped.economics.parasitic import (
    default_electrical_loads,
    total_parasitic_electricity_annual_usd_per_m2,
)
from waste_heat_lumped.economics.params import C_DEVICE_USD, KG_WATER_PER_M3, LCOEconomicParams
