...
from waste_heat_lumped.physics.conde2004 import (
...
def water_activity_from_c_w(
    ...
    *,
    ...
    from waste_heat_lumped.physics.brine_equilibrium import (
...
def equilibrium_c_w_at_rh(
    ...
    *,
    ...
    if salt_name == "LiCl":
        ...
        from waste_heat_lumped.physics.brine_equilibrium import equilibrate_salt_mf
