...
def test_vacuum_desorption_flux():
    m1 = m_des_kg_s_m2(temperature_c=50.0, p_cond_pa=3000.0, c_vac_kg_s_pa_m2=1e-8)
    m2 = m_des_kg_s_m2(temperature_c=50.0, p_cond_pa=3000.0, c_vac_kg_s_pa_m2=2e-8)
    assert m2 == pytest.approx(2.0 * m1)
    m0 = m_des_kg_s_m2(temperature_c=10.0, p_cond_pa=5000.0, c_vac_kg_s_pa_m2=1e-8)
    assert m0 == 0.0
