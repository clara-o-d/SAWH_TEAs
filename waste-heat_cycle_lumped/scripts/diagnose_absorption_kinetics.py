...
from waste_heat_cycle_lumped.simulation.ode_system import run_cycle
...
def _print_state_comparison(config: DeviceConfig) -> None:
    ...
    from waste_heat_cycle_lumped.physics.salt_properties import WATER_MOLAR_MASS_KG_MOL
